...
# Atenuación del azul Azure Drift

- [x] Reducir ligeramente la luminosidad del degradado Azure Drift sin cambiar su identidad cromática.
- [x] Conservar el contraste y el acabado glass de los controles azules.
- [x] Validar vista previa, pruebas y compilación antes de publicar.
