...
# Degradado uniforme y optimización sin cambios funcionales

- [x] Auditar todos los patrones de botones y delimitar la exclusión del apartado Plugin.
- [x] Aplicar el degradado azul de marca de forma uniforme a los botones fuera de Plugin.
- [x] Identificar y reducir las causas principales de lag sin alterar ninguna funcionalidad ni contenido.
- [x] Validar la exclusión de Plugin, consistencia visual, rendimiento, pruebas y compilación antes de publicar.
