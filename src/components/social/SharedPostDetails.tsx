        ...
        <div className="space-y-1.5">
          {post.documents.map((document) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 rounded-xl border border-border/60 bg-muted/25 px-2.5 py-2 text-left transition-colors hover:border-primary/30 hover:bg-primary/[0.05]"
            >
              <span className="grid h-7 w-7 shrink-0 place-items-center rounded-lg bg-primary/10 text-primary"><FileText size={13} /></span>
              <span className="min-w-0 flex-1 truncate text-[11px] font-medium">{document.name}</span>
